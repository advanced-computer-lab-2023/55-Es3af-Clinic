...
doctorRouter
  ...
  .get(doctorController.getAllPrescriptions);
doctorRouter.get("/notifi", userController.getNotifications);
doctorRouter
  .route("/scheduleFollowUpAppointment")
  .post(doctorController.scheduleFollowUpAppointment);
...
doctorRouter
  .route("/getAmountInWallet")
  .get(doctorController.getAmountInWallet);
...
doctorRouter
  .route("/uploadHealthRec")
  .post(doctorController.uploadPatientHealthRec);

//doctorRouter.route("/followupAppointment").post(doctorController.followupAppointment);
doctorRouter
  .route("/getAppointmentsWithStatusDone")
  .get(doctorController.getAppointmentsWithStatusDone);
// doctorRouter.route('/viewMedicalHistory').get(doctorController.viewMedicalHistory);
doctorRouter
  .route("/cancelAppointment")
  .put(doctorController.cancelAppointment);
doctorRouter.put(
  "/acceptOrRevokeFollowUp",
  doctorController.acceptOrRevokeFollowUp
);
...
doctorRouter
  ...
  .put(doctorController.rescheduleAnAppointment);
doctorRouter.route("/getDoctor").get(doctorController.getDoctor);
doctorRouter.route("/getName/:patientID").get(doctorController.getName);
