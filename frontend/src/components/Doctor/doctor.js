...
function DoctorPage() {
  return (
    <Routes>
      ...
      <Route
        path="/filterPatientsByUpcomingPendingAppointments"
        element={<FilteredPatientsByAppointments />}
      />
      <Route path="/" element={<DoctorHome />} />
      <Route path="/addTimeSlots" element={<AddTimeSlots />} />
      <Route
        path="/uploadPatientHealthRecords"
        element={<UploadPatientHealthRecords />}
      />
    ...
    <div className="App">
      ...
      <header className="App-header">
        <div>
          ...
          <a
            href="/doctor/filterAppointmentsByDateAndStatus"
          ...
          <a
            href="/doctor/filterPatientsByUpcomingPendingAppointments"
            rel="noopener noreferrer"
          >
            <button className="btn btn-primary">
              {" "}
          ...
          <a
            href="/doctor/uploadPatientHealthRecords"
            rel="noopener noreferrer"
          >
            <button className="btn btn-primary">
          ...
          <a
            ...
            rel="./components/doctor/viewEmploymentContract.js"
          >
